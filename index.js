...
async function startzaki() {
    const zaki = zakiConnect({
        ...
        browser: ['Pindra Gultom','Safari','3.0.0'],
        auth: state
    })
    ...
    // Get Profile Picture Group
       ...
       ppgc = 'https://i.ibb.co/tqBw30L/Lovers-Bot.jpg'
       }
       let wm_fatih = { url : ppgc }
       if (pea[0].announce == true) {
       zaki.send5ButImg(pea[0].id, `「 Perubahan Pengaturan Grup 」\n\nGroup telah ditutup oleh admin, Sekarang hanya admin yang dapat mengirim pesan !`, `Pengaturan Grup Ubah Pesan`, wm_fatih, [])
       } else if(pea[0].announce == false) {
       zaki.send5ButImg(pea[0].id, `「 Perubahan Pengaturan Grup 」\n\nGroup telah dibuka oleh admin, Sekarang peserta dapat mengirim pesan !`, `Pengaturan Grup Ubah Pesan`, wm_fatih, [])
       } else if (pea[0].restrict == true) {
       zaki.send5ButImg(pea[0].id, `「 Perubahan Pengaturan Grup 」\n\nInfo group telah dibatasi, Sekarang hanya admin yang dapat mengedit info group !`, `Pengaturan Grup Ubah Pesan`, wm_fatih, [])
       } else if (pea[0].restrict == false) {
       zaki.send5ButImg(pea[0].id, `「 Perubahan Pengaturan Grup 」\n\nInfo group telah dibuka, Sekarang peserta dapat mengedit info group !`, `Pengaturan Grup Ubah Pesan`, wm_fatih, [])
       } else {
       zaki.send5ButImg(pea[0].id, `「 Perubahan Pengaturan Grup 」\n\nGroup Subject telah diganti menjadi *${pea[0].subject}*`, `Pengaturan Grup Ubah Pesan`, wm_fatih, [])
     }
    })
